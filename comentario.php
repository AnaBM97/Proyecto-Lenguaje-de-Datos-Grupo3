                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                           <a class="dropdown-item" href="combo_desayuno.php" style="font-family:Sans-serif; font-size:16px;">Combos de Desyuno</a>
...
<form action="comentario.php" id="frm_comentarios" method="post">
     ...
     <?php
        ...
        <div class="container p-3 my-3 bg-dark">
            ...
            <br>
            <textarea id="campoComentario" name="campoComentario" cols="140" rows="3" style="resize: both;"></textarea>
            <br>
