...
<body style="background-color: #ffecd2;">
...
<div class="jumbotron text-center" style="margin-bottom:0;background-color:#ffecd2;">
    ...
    <div class="container" style="margin-right: 200px;" >
        ...
        <div class="row">
            ...
            <br>
            <br>
            <input type="button " style="margin-right: 20px;" id="botonRegistrar" name="botonRegistrar" value="Registrar Usuario " class="btn btn-primary " onclick="enviarRegistro();">
