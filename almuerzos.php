...
session_start();
	...
	$sql = 'BEGIN PRD_GET_MONITOR(:DATOS); END;';            
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="combo_desayuno.php" style="font-family:Sans-serif; font-size:16px;">Combos de Desayuno</a></div>
                    </div>
                </li>
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="almuerzos.php" style="font-family:Sans-serif; font-size:16px;">Almuerzos</a>
                        </div>
                    </div>
                </li>
